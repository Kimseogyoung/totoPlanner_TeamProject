...
public class PlannerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textTextView = (TextView) convertView.findViewById(R.id.pitem_tv) ;

        // Data Set(listViewItemList)에서 position에 위치한 데이터 참조 획득
        PlannerItems listViewItem = listViewItemList.get(position);
    ...
    public void addItem(String text) {
        PlannerItems item = new PlannerItems();
